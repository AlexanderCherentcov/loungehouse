...
export class FullPage {
	constructor(element, options) {
		let config = {
			...
			classInit: 'fp-init',
			// Класс для врапера во время сворачивания 
	...
	init() {
		...
		setTimeout(() => {
			...
			// Создание костюмного мероприятия
	...
	touchMove(e) {
		...
		//===============================
		// Проверка на завершение анимации и наличие не двойного блока
	...
	wheel(e) {
		// Проверка на наличие не двойного блока
