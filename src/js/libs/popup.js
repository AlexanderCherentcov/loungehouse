// Модуль попапов
// (c) фрилансер по жизни, "угрюмый кот"
	...
	constructor(options) {
		let config = {
			...
			classes: {
				...
				bodyActive: 'popup-show', // Прилагается для боди, когда попал открытый
			},
			focusCatch: true, // Фокус внутри попапа зациклен
			closeEsc: true, // Закритие ESC
	...
	open(selectorValue) {
		if (bodyLockStatus) {
			...
			if (this.targetOpen.element) {
				...
				// Создаем свое событие после открытия папа
